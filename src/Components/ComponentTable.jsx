...
//             <th className="border p-2 text-left">Single Quantity</th>
//             <th className="border p-2 text-left">Order Quantity</th>
...
export default function ComponentTable({ users }) {
  ...
  async function saveRawMaterial(bomIndex, rawIndex) {
    ...
    if (isDuplicate) {
      toast.error(`"${row.SKU}" is already added in this BOM.`);
      return;
    }
